...
namespace Proyecto_Tienda.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Correo,Telefono,FechaCreacion")] Consulta consulta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,Correo,Telefono,FechaCreacion")] Consulta consulta)
        {
            if (id != consulta.Id)
            {
                return NotFound();
